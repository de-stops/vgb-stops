...
This is a simple script to download all [VGB](http://www.vgb-mob.de) stops as [GTFS-compatible CSV](https://developers.google.com/transit/gtfs/reference/stops-file).
...
"171692","Nordlohne(Wietmarschen) Siedlung",7.259095,52.525193,""
```
